...
export default function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    <aside className="w-full border-l border-gray-200 h-screen overflow-y-auto  transition-all duration-300 flex flex-col">
            ...
            return (
              <li key={item.href}>
                ...
                >
                  ...
                  <span
                    className={`text-base flex-1 whitespace-nowrap tracking-wide ${
      ...
      <div className="shrink-0 w-full p-3 border-t border-gray-200 bg-gradient-to-t from-gray-50/50 to-white">
        ...
        >
          ...
          <span className="font-bold text-base whitespace-nowrap flex-1 tracking-wide">
            خروج از سامانه
          </span>
